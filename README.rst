...
.. |build| image:: https://jenkins.riptide.parakoopa.de/buildStatus/icon?job=riptide-all%2Fmaster
    :target: https://jenkins.riptide.parakoopa.de/blue/organizations/jenkins/riptide-all/activity
    :alt: Build Status

...
buildPythonPackage {
  ...
  postFixup = ''
    ...
    echo "_RIPTIDE_COMPLETE=bash_source $out/bin/riptide" >> $out/bin/nix-riptide.hook.bash
    ...
    echo "_RIPTIDE_COMPLETE=zsh_source $out/bin/riptide" >> $out/bin/nix-riptide.hook.zsh
